...
app.use(route.get("/api/log", log));
app.use(route.get("/api/key", key));
app.use(route.get("/api/apps", apps));
app.use(route.get("/api/whoami", whoami));
...
app.use(route.get("/api/app", app_));
